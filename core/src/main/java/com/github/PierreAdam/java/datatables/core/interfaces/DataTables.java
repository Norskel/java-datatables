...
package com.github.PierreAdam.java.datatables.core.interfaces;
...
public interface DataTables<E, S, C, U extends DataTables<E, S, C, U>> {
     ...
     * @return the init provider consumer
     */
     ...
     * @return the field display supplier
     */
     ...
     * @return the global search handler
     */
